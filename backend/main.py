...
async def register(request: RegisterRequest):
    try:
        ...
        from database.pending_db import add_pending_user
        add_pending_user(token, request.name, request.phone, request.rfid_id)
        # Deferred insertion after Telegram verification (handled by bot)
